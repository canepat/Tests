...
public class Ping
{
    ...
    public static void main(final String[] args) throws Exception
    {
        ...
        {
            System.out.println("Warming up... " + WARMUP_NUMBER_OF_ITERATIONS + " iterations of " + WARMUP_NUMBER_OF_MESSAGES +
                " messages");
                 ...
                 final Subscription subscription = aeron.addSubscription(PONG_CHANNEL, PONG_STREAM_ID))
            {
                ...
                do
                {
                    ...
                    final long elapsedTime = sendPingAndReceivePong(fragmentHandler, publication, subscription,
                        NUMBER_OF_MESSAGES);
    ...
    {
        System.out.format("Available image: channel=%s streamId=%d session=%d\n", image.subscription().channel(),
            image.subscription().streamId(), image.sessionId());
