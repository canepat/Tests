...
public class EmbeddedIpcPingPong
{
    ...
    private static void runPing(final String embeddedDirName) throws InterruptedException
    {
        final Aeron.Context ctx = new Aeron.Context()
            .availableImageHandler(EmbeddedIpcPingPong::availablePongImageHandler);
        ...
        final FragmentAssembler dataHandler = new FragmentAssembler(EmbeddedIpcPingPong::pongHandler);
