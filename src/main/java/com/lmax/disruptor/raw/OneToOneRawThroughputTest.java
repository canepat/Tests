...
public final class OneToOneRawThroughputTest extends AbstractPerfTestDisruptor
{
    ...
    protected long runDisruptorPass() throws InterruptedException
    {
        ...
        final long expectedCount = myRunnable.sequence.get() + ITERATIONS;
        ...
        latch.await();
        final long opsPerSecond = (ITERATIONS * 1000L) / (System.currentTimeMillis() - start);
        waitForEventProcessorSequence(expectedCount);

        failIfNot(expectedCount, myRunnable.sequence.get());
    ...
    private static class MyRunnable implements Runnable
    {
        ...
        public void run()
        {
            final long expected = expectedCount;
            long processed = -1;
    ...
    {
        final OneToOneRawThroughputTest test = new OneToOneRawThroughputTest();
